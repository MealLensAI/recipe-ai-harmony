#!/usr/bin/env python3
"""
Test script to simulate a payment and see if subscription gets activated
"""
...
def test_payment_activation():
    print("🧪 TESTING PAYMENT ACTIVATION")
    print("=" * 50)
    
    # Get a test user ID from our debug results
    test_user_id = "cd9d8fed-6e82-4831-9890-99c87a2eb8cc"  # From debug output
    ...
    # Test 2: Try to activate subscription for 1 minute (for quick testing)
    print("\n💳 TESTING SUBSCRIPTION ACTIVATION:")
    print("-" * 30)
    try:
        # Use whole number for testing (database expects integer)

#!/usr/bin/env python3
"""
Test the minutes fix
"""

import requests
import json

def test_minutes_fix():
    """Test the minutes fix"""
    
    print("🔧 Testing Minutes Fix")
    print("=" * 30)
    ...
    try:
        print("🧪 Testing 1-minute subscription...")
        ...
        if response.status_code == 200:
            ...
            if result.get('success'):
                print("✅ SUCCESS: 1-minute subscription activated!")
                ...
                print("\n🎉 Minutes fix is working!")
                print("💡 Now wait 1 minute and refresh your frontend to see the expiry!")
            else:
